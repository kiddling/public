<template>
  <div class="space-y-4">
    ...
    <div v-if="suggestions.length > 0" class="px-2">
      ...
      <div class="flex flex-wrap gap-2">
        <button
          ...
          :key="suggestion"
          type="button"
          class="hover:bg-primary-100 hover:text-primary-700 dark:hover:bg-primary-900/30 dark:hover:text-primary-300 rounded-full bg-gray-100 px-3 py-1 text-xs font-medium text-gray-700 transition dark:bg-gray-800 dark:text-gray-300"
    ...
    <div
      v-if="total > pageSize"
      class="border-t border-gray-200 px-4 py-3 text-center dark:border-gray-800"
    >
