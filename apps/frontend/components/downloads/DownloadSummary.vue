<template>
  <div class="rounded-lg border bg-white p-4 shadow-sm dark:bg-gray-800 dark:border-gray-700">
    ...
    <div v-else class="space-y-2">
      ...
      >
        ...
        <div class="flex-shrink-0">
          <span
            ...
            :class="item.checksumValid ? 'bg-green-100 text-green-600 dark:bg-green-900 dark:text-green-200' : 'bg-red-100 text-red-600 dark:bg-red-900 dark:text-red-200'"
      ...
      <div v-if="history.length > 5" class="text-center pt-2">
        <button
          type="button"
