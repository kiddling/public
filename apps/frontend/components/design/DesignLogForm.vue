<template>
  <div class="design-log-form max-w-4xl mx-auto p-6">
    <h2 class="text-2xl font-bold mb-6">设计日志 (Design Log)</h2>
    ...
    <form @submit.prevent="submitLog" class="space-y-6">
      ...
      <div class="space-y-4">
        ...
        <div>
          <label for="inspiration" class="block text-sm font-medium mb-2">
            灵感来源
          </label>
          <textarea
            id="inspiration"
        ...
        <div>
          <label for="process" class="block text-sm font-medium mb-2">
            设计步骤 *
          </label>
          <textarea
            id="process"
        ...
        <div>
          <label for="challenges" class="block text-sm font-medium mb-2">
            遇到的挑战
          </label>
          <textarea
            id="challenges"
      ...
      <div class="space-y-4">
        ...
        <div>
          <label for="outcome" class="block text-sm font-medium mb-2">
            最终成果 *
          </label>
          <textarea
            id="outcome"
        ...
        <div>
          <label for="nextSteps" class="block text-sm font-medium mb-2">
            后续计划
          </label>
          <textarea
            id="nextSteps"
      ...
      <div class="space-y-4">
        ...
        <div>
          <label for="tools" class="block text-sm font-medium mb-2">
            使用工具
          </label>
          <input
            id="tools"
      ...
      <div class="flex gap-4 pt-4">
        ...
        <button
          type="button"
          @click="resetForm"
          class="px-6 py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-colors"
        >
          重置
        </button>
      </div>
