<template>
  <div class="design-log-page min-h-screen bg-gray-50 py-8 dark:bg-gray-900">
    <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
      <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Design Log</h1>
        <p class="mt-2 text-lg text-gray-600 dark:text-gray-400">
          Document your design process, decisions, and iterations
        </p>
        <div
          v-if="template?.guidance"
  ...
  meta: [
    {
      name: 'description',
      content:
        'Document your design process with our interactive design log tool. Track decisions, iterations, and reflections.',
    },
  ],
})
</script>
