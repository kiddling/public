...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    ...
    public: {
      ...
      securityHstsIncludeSubdomains:
        process.env.NUXT_PUBLIC_SECURITY_HSTS_INCLUDE_SUBDOMAINS || 'true',
      ...
      securityCspScriptSrc:
        process.env.NUXT_PUBLIC_SECURITY_CSP_SCRIPT_SRC || "'self' 'unsafe-inline' 'unsafe-eval'",
      securityCspStyleSrc:
        process.env.NUXT_PUBLIC_SECURITY_CSP_STYLE_SRC || "'self' 'unsafe-inline'",
      ...
      securityCspUpgradeInsecureRequests:
        process.env.NUXT_PUBLIC_SECURITY_CSP_UPGRADE_INSECURE_REQUESTS || 'true',
      ...
      securityReferrerPolicy:
        process.env.NUXT_PUBLIC_SECURITY_REFERRER_POLICY || 'strict-origin-when-cross-origin',
      securityPermissionsPolicy:
        process.env.NUXT_PUBLIC_SECURITY_PERMISSIONS_POLICY ||
        'camera=(), microphone=(), geolocation=()',
      securityXContentTypeOptions:
        process.env.NUXT_PUBLIC_SECURITY_X_CONTENT_TYPE_OPTIONS || 'true',
      ...
      securityRateLimitMaxRequests:
        process.env.NUXT_PUBLIC_SECURITY_RATE_LIMIT_MAX_REQUESTS || '100',
      securityRateLimitWindowMs: process.env.NUXT_PUBLIC_SECURITY_RATE_LIMIT_WINDOW_MS || '60000',
      securityRateLimitSkipPaths:
        process.env.NUXT_PUBLIC_SECURITY_RATE_LIMIT_SKIP_PATHS || '/_nuxt,/fonts,/images,/_ipx',
    },
  },
  ...
  nitro: {
    ...
    prerender: {
      ...
      ignore: ['/lessons/**', '/knowledge-cards/**', '/api/**'],
    },
      ...
      rollupOptions: {
        output: {
          ...
          manualChunks: (id) => {
            ...
            if (
              id.includes('/pages/knowledge-cards/') ||
              id.includes('/components/knowledge-cards/')
            ) {
